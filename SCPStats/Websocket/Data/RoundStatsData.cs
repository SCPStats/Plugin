...
namespace SCPStats.Websocket.Data
{
    public class RoundStatsData
    {
        ...
        public RoundStatsData(string data)
        {
            try
            {
                ...
                var players = Player.List
                    .Where(pl => !Helper.IsPlayerNPC(pl) && !pl.ReferenceHub.isLocalPlayer && pl.IsVerified)
                    .ToDictionary(Helper.HandleId, pl => pl);
            ...
            {
                Log.Error("An error occurred while parsing RoundStatsData. Here's the details: \"" + data + "\".");
                throw e;
            }
        }
        ...
        private Player ParseScore(string data, string propName, Dictionary<string, Player> playersDict)
        {
            ...
            {
                Log.Error("An error occurred while parsing a score. Here's the details: \"" + data + "\", \"" + propName + "\".");
                throw e;
            }
        }
    }
